...
if [ "$HAS_DOTNET" = true ]; then
    ...
    echo "     dotnet run --project src/TradingBot.Console"
    echo "     → Dashboard: https://github.com/HKUDS/Vibe-Trading (external project)"
    echo ""
    echo "  3. Run tests:"
    echo "     dotnet test"
    echo ""
    ...
    echo "     - Trading Dashboard: https://github.com/HKUDS/Vibe-Trading (external project)"
