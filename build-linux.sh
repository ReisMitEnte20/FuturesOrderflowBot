...
print_step "Building Console app..."
dotnet build src/TradingBot.Console/TradingBot.Console.csproj --configuration Debug > /dev/null 2>&1
print_status "Console app ready"
...
echo ""
echo "1. Dashboard:"
echo "   The internal DevDashboard was removed. Use the external"
echo "   HKUDS/Vibe-Trading project instead: https://github.com/HKUDS/Vibe-Trading"
echo ""
